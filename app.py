...
<head>
    ...
    <title>Mobile Tracker Pro - FLEXYxSOUL</title>
...
<body>
    <div class="container">
        <header>
            ...
            <p class="subtitle">Powered by FLEXER</p>
        </header>
     ...
     num                  <i class="fas fa-copy"></i>
        ...
        <footer class="footer">
            <p>© 2025 Mobile Tracker Pro | Developed by <a href="#">FLEXYXSOUL</a></p>
            <p>Join our Telegram: <a href="#">@rich_flexy</a></p>
        </footer>
    </div>
